import { map, setKey } from '@rapid/signal-extensions/patterns';
...
import * as core from '@rapid/signal'; // Import actual core functions

// Define mockRouterStore *before* vi.mock uses it
// Note: map() moved to @rapid/signal-extensions/patterns
