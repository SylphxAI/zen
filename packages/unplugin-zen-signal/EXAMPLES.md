...
```bash
npm install vite @vitejs/plugin-react unplugin-zen-signal @zen/signal
```
...
**1. Install dependencies:**
```bash
npm install vite @vitejs/plugin-vue unplugin-zen-signal @zen/signal
```
...
**1. Install dependencies:**
```bash
npm install vite @sveltejs/vite-plugin-svelte unplugin-zen-signal @zen/signal
```
...
```ts
import { signal, batch } from '@zen/signal';
